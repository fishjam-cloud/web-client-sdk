...
import { installFakeMediaDevices } from "./fakeMediaDevices";
...
export const it = base.extend({
    ...
    service: async ({ media: _media, signalling }, provide) => {
        const service = new FishjamService(new FishjamClient({
...
export const connectAndJoin = async (service, signalling) => {
