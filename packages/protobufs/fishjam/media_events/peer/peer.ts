...
export interface MediaEvent_UnmuteTrack {
  trackId: string;
}
...
export const MediaEvent: MessageFns<MediaEvent> = {
  encode(message: MediaEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.unmuteTrack !== undefined) {
  ...
  fromJSON(object: any): MediaEvent {
    return {
      ...
      setTargetTrackVariant: isSet(object.setTargetTrackVariant)
        ...
        : undefined,
      unmuteTrack: isSet(object.unmuteTrack) ? MediaEvent_UnmuteTrack.fromJSON(object.unmuteTrack) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MediaEvent>, I>>(object: I): MediaEvent {
    ...
    message.setTargetTrackVariant =
      (object.setTargetTrackVariant !== undefined && object.setTargetTrackVariant !== null)
        ...
        : undefined;
    message.unmuteTrack = (object.unmuteTrack !== undefined && object.unmuteTrack !== null)
      ? MediaEvent_UnmuteTrack.fromPartial(object.unmuteTrack)
      : undefined;
    return message;
  },
};
...
function createBaseMediaEvent_UnmuteTrack(): MediaEvent_UnmuteTrack {
  return { trackId: "" };
}

export const MediaEvent_UnmuteTrack: MessageFns<MediaEvent_UnmuteTrack> = {
  encode(message: MediaEvent_UnmuteTrack, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.trackId !== "") {
      writer.uint32(10).string(message.trackId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MediaEvent_UnmuteTrack {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MediaEvent_UnmuteTrack {
    return { trackId: isSet(object.trackId) ? globalThis.String(object.trackId) : "" };
  },

  toJSON(message: MediaEvent_UnmuteTrack): unknown {
    const obj: any = {};
    if (message.trackId !== "") {
      obj.trackId = message.trackId;
    }
  ...
  create<I extends Exact<DeepPartial<MediaEvent_UnmuteTrack>, I>>(base?: I): MediaEvent_UnmuteTrack {
    return MediaEvent_UnmuteTrack.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MediaEvent_UnmuteTrack>, I>>(object: I): MediaEvent_UnmuteTrack {
    const message = createBaseMediaEvent_UnmuteTrack();
    message.trackId = object.trackId ?? "";
    return message;
  },
