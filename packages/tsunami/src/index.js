export { classifyDeviceError, DeviceError, DeviceNotFoundError, DeviceOverconstrainedError, DevicePermissionDeniedError, UnknownDeviceError, } from "./devices/errors";
