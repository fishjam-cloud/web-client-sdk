const REVERSE_PROXY_PORT = 5555;
const WEBRTC_CLIENT_PORT = 5173;
const REACT_CLIENT_PORT = 3007;

export const FISHJAM_STACK_URL = `http://localhost:${REVERSE_PROXY_PORT}`;
export const FISHJAM_STACK_WS_URL = `ws://localhost:${REVERSE_PROXY_PORT}/socket/peer/websocket`
